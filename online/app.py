...
def get_rooms():
    ...
    rooms_list = [{"id": room.id, "name": room.name, "description": room.description, "capacity": room.capacity} for room in rooms]
...
def room_schedule(room_id):
    ...
    return jsonify({"room": room.name, "schedule": schedule}), 200
